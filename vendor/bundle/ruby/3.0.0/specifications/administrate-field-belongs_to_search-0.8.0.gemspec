# -*- encoding: utf-8 -*-
# stub: administrate-field-belongs_to_search 0.8.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<rails>.freeze, [">= 4.2", "< 7.1"])
    ...
    s.add_dependency(%q<administrate>.freeze, [">= 0.3", "< 1.0"])
    s.add_dependency(%q<jbuilder>.freeze, ["~> 2"])
    s.add_dependency(%q<rails>.freeze, [">= 4.2", "< 7.1"])
